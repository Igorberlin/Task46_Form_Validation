...
function formSubmitHandler(event) {
    ...
    const form = event.target,
        name = form.querySelector('#inputName'),
        phone = form.querySelector('#inputPhone'),
        email = form.querySelector('#inputEmail'),
        address = form.querySelector('#inputAddress');
    ...
    //     alert.innerText = 'Fill all inputs';
    //     root.append(alert);
    // }
}
    function checkTextArea() {
        const textAreaValue = document.querySelector('#inputDesc');
